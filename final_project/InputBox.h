...
void	show(CIB_OBJ LPCWSTR lpszTitle, LPCWSTR	lpszQuery);
void	hide(CIB_OBJ1);
...
int ShowInputBox(CIB_OBJ HWND hParentWindow, LPCTSTR lpszTitle, LPCTSTR lpszQuery, LPWSTR szResult, WORD wMax);
#ifdef	__cplusplus
};
#endif
