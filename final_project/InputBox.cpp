/* **************************************************************************
 * @version $Id: CInputBox.cpp,v 0.1 2006/03/31 02:26:00 legolas558 Exp $
 *
 * File:		CInputBoxTest.cpp
 * Content:		main source code for CInputBox class
 * Notes:		class code wrapper for C++ language rules
 *
...
#define		CIB_CLASS_NAME L"CInputBox558"
#define		CIB_SPAN 10
...
CIB_DECL CIB_CONSTRUCTOR(CIB_OBJ HINSTANCE hInst)
{
	...
	this->hwndInputBox = CreateWindow(	CIB_CLASS_NAME, L"",
...
void	CIB_DECL create(CIB_OBJ HWND hwndNew)
{
	...
	this->hwndQuery =	CreateWindow(L"Static", L"", WS_CHILD | WS_VISIBLE,
							CIB_LEFT_OFFSET, CIB_TOP_OFFSET,
							CIB_WIDTH-CIB_LEFT_OFFSET*2, CIB_BTN_HEIGHT*2,
							this->hwndInputBox, NULL,
							this->hThisInstance, NULL);
	this->hwndEditBox = CreateWindow(L"Edit", L"", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_AUTOHSCROLL | ES_LEFT, CIB_LEFT_OFFSET,
							CIB_TOP_OFFSET + CIB_BTN_HEIGHT*2, CIB_WIDTH-CIB_LEFT_OFFSET*3, CIB_BTN_HEIGHT,
							this->hwndInputBox,	NULL,
							this->hThisInstance, NULL);
	this->hwndOk =		CreateWindow(L"Button", L"OK", WS_CHILD | WS_VISIBLE | WS_TABSTOP | BS_PUSHBUTTON,
							...
							this->hThisInstance, NULL);
	this->hwndCancel =	CreateWindow(L"Button", L"Cancel",
...
void	CIB_DECL show(CIB_OBJ LPCWSTR lpszTitle, LPCWSTR	lpszQuery) {
...
int CIB_DECL ShowInputBox(CIB_OBJ HWND hwndParentWindow, LPCTSTR lpszTitle, LPCTSTR lpszQuery, LPWSTR szResult, WORD wMax)
{
	MSG	msg;
	BOOL	bRet;
